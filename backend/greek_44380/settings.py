"""
Django settings for greek_44380 project.
...
WSGI_APPLICATION = 'greek_44380.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "greek_44380 API",
    "DESCRIPTION": "API documentation for greek_44380 App",
    "VERSION": "v1",
}
